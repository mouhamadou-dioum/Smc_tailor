        ...
        <div class="container">
            <div class="navbar-inner">
                ...
                <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo e(route('home')); ?>">
                    ...
                    <?php else: ?>
                        <img src="<?php echo e(asset('logo.png')); ?>?v=4" alt="SMC Couture" style="height: 55px; width: auto; object-fit: contain; border-radius: 4px;">
                    <?php endif; ?>
                </a>
                ...
                <div class="nav-actions" id="navMenu">
                    ...
                    <?php if($isAdmin): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link-custom">
                            <i class="fas fa-chart-line"></i><span>Tableau de bord</span>
                        </a>
                        <a href="<?php echo e(route('admin.vetements.index')); ?>" class="nav-link-custom">
                            <i class="fas fa-shirt"></i><span>Vêtements</span>
                        </a>
                        <a href="<?php echo e(route('admin.categories.index')); ?>" class="nav-link-custom">
                            <i class="fas fa-tags"></i><span>Catégories</span>
                        </a>
                        <a href="<?php echo e(route('admin.rendezvous.index')); ?>" class="nav-link-custom">
                    ...
                    <?php else: ?>
                        ...
                        <div class="nav-socials">
                            ...
                            <?php $adminPhone = \App\Models\Admin::first()?->telephone ?? '221771234567'; $waNum = preg_replace('/\D+/', '', $adminPhone); if(strlen($waNum)===9) $waNum='221'.$waNum; ?>
                            <a href="https://wa.me/<?php echo e($waNum); ?>" target="_blank" class="nav-social-icon nav-social-wa" aria-label="WhatsApp">
    ...
    <footer class="site-footer">
        ...
        <div class="footer-body">
            <div class="footer-grid">
                ...
                <div class="footer-col footer-col-brand">
                    <?php if(config('app.theme_mode') === 'alternative'): ?>
                        <a href="<?php echo e(route('home')); ?>" class="footer-logo">AURA<span>—</span>COUTURE</a>
        ...
        <div class="footer-bottom">
            <div class="footer-bottom-inner">
                <?php if(config('app.theme_mode') === 'alternative'): ?>
                    <span class="footer-copy">© <?php echo e(date('Y')); ?> AURA Couture. Tous droits réservés.</span>
                <?php else: ?>
...
</html><?php /**PATH C:\Users\fallou\projet laravel\couture-app\resources\views/layouts/master.blade.php ENDPATH**/ ?>