...
<div class="admin-page">
    <div class="container">
        ...
        <div class="admin-header">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-outline-custom" style="border-color: rgba(255,255,255,0.4); color: #fff;">
                        ...
                        <div class="admin-card">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex gap-3">
                                    ...
                                    <div>
                                        <h5 class="mb-1" style="font-family:'Playfair Display',serif;"><?php echo e($categorie->nom); ?></h5>
                                        <p class="text-muted mb-2" style="font-size:0.875rem;"><?php echo e($categorie->description ?? 'Aucune description'); ?></p>
                                        <span class="category-count">
                                            <i class="fas fa-tshirt fa-xs me-1"></i><?php echo e($categorie->vetements->count()); ?> vêtement(s)
                                        </span>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fallou\projet laravel\couture-app\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>