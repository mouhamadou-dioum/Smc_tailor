<?php $__env->startSection('title', 'Suivre mon Rendez-vous - Couture App'); ?>
...
<div class="suivi-page">
    <div class="container">
        ...
        <div class="search-card">
            <form method="GET" action="<?php echo e(route('rendezvous.suivi')); ?>">
                <div class="mb-3">
                    <input
                        type="text"
                        name="telephone"
                        class="form-control-suivi <?php if($error): ?> is-invalid <?php endif; ?>"
                        placeholder="Ex : +221 77 123 45 67"
                        required
                        value="<?php echo e(old('telephone', $telephone)); ?>"
                    >
                    <?php if($error): ?>
                ...
                <div class="rdv-card <?php echo e($statutClass); ?>">
                    ...
                    <div class="rdv-info">
                        <div class="rdv-vetement">
                            <?php echo e($vetNom ?? 'Rendez-vous général (Mesures / Conseil)'); ?>

                        </div>
                        <?php if($rdv->commentaire): ?>
                        <div class="rdv-comment mt-1">
                            <i class="fas fa-comment-dots fa-xs me-1"></i><?php echo e(\Illuminate\Support\Str::limit($rdv->commentaire, 80)); ?>
                    ...
                    <div class="production-timeline-container" style="grid-column: 1 / -1; margin-top: 1rem; padding-top: 1rem; border-top: 1px dashed var(--gray-200);">
                        <div style="font-size:0.82rem; font-weight:700; color:var(--dark); margin-bottom:0.75rem; font-family:'Playfair Display', serif; display:flex; align-items:center; gap:0.4rem; flex-wrap:wrap;">
                            ...
                            <span style="color:var(--primary); font-weight:800;">
                                ...
                                <?php elseif($currentProd === 'COUTURE'): ?> Couture & Assemblage en cours
                                <?php elseif($currentProd === 'FINITIONS'): ?> Finitions et repassage en cours
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fallou\projet laravel\couture-app\resources\views/rendezvous/suivi.blade.php ENDPATH**/ ?>