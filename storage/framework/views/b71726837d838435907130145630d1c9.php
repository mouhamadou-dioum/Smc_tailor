<?php $__env->startSection('title', 'Mot de passe oublié - Couture App'); ?>
                ...
                <div class="auth-card">
                    ...
                    <form method="POST" action="<?php echo e(route('password.email')); ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" class="auth-input" required placeholder="votre@email.com" value="<?php echo e(old('email')); ?>">
                        </div>
                        
                        <button type="submit" class="auth-btn mb-3">Envoyer le lien de réinitialisation</button>
                    </form>

                    <?php if(session('debug_link')): ?>
                        <div class="mt-3" style="background:#e0f2fe; border: 1px solid #bae6fd; color:#0369a1; border-radius:8px; padding:0.85rem; font-size:0.82rem; line-height: 1.4;">
                            ...
                            <a href="<?php echo e(session('debug_link')); ?>" style="color:#0284c7; font-weight:700; word-break:break-all; text-decoration: underline; display:block; margin-top:5px;"><?php echo e(session('debug_link')); ?></a>
                        </div>
                    <?php endif; ?>
                    
                    <p class="text-center mt-3 mb-0" style="color:#6c757d;">
                        Retourner à la <a href="<?php echo e(route('login')); ?>" class="auth-link">Connexion</a>
                    </p>
                </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fallou\projet laravel\couture-app\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>