...
<div class="admin-page">
    <div class="container">
        ...
        <div class="admin-header">
            ...
            <a href="<?php echo e(route('admin.vetements.create')); ?>" class="btn btn-primary-custom">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6 col-lg-4" id="row-<?php echo e($vetement->id); ?>">
                <div class="vetement-card" style="flex-direction:column;align-items:stretch;">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        ?>
                        <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($vetement->nom); ?>" 
                        ...
                        <div class="vetement-info">
                            <div class="vetement-title"><?php echo e($vetement->nom); ?></div>
                            <div class="vetement-meta">
                                <i class="fas fa-tag fa-xs me-1"></i><?php echo e($vetement->categorie->nom ?? 'Non classé'); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3 pt-3" style="border-top:1px solid var(--gray-200);">
                        <div class="d-flex align-items-center gap-3">
                            <span class="vetement-price"><?php echo e(number_format($vetement->prix, 0, ',', ' ')); ?> CFA</span>
                            <span class="status-badge <?php echo e($vetement->disponible ? 'disponible' : 'indisponible'); ?>">
                                <?php echo e($vetement->disponible ? 'Disponible' : 'Indisponible'); ?>

                            </span>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('admin.vetements.edit', $vetement->id)); ?>" class="action-btn edit" title="Modifier">
                                <i class="fas fa-edit"></i>
                            </a>
                            <button onclick="deleteVetement(<?php echo e($vetement->id); ?>)" class="action-btn delete" title="Supprimer">
            ...
            <div class="col-12">
                <div class="text-center py-5">
                    ...
                    <a href="<?php echo e(route('admin.vetements.create')); ?>" class="btn btn-primary-custom mt-2">
                        <i class="fas fa-plus me-2"></i> Ajouter un vêtement
                    </a>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fallou\projet laravel\couture-app\resources\views/admin/vetements/index.blade.php ENDPATH**/ ?>