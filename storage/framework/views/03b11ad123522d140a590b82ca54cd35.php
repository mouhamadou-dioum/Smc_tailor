...
<section id="collection-section" class="section section-warm">
    <div class="container">
        <div class="collection-header">
            ...
            <a href="<?php echo e(route('vetements.index')); ?>" class="btn-outline-gold" data-reveal="fade-up" data-delay="100">
        ...
        <div class="collection-grid">
            ...
            <div class="vet-card" data-reveal="fade-up" data-delay="<?php echo e($loop->index * 100); ?>">
                ...
                <div class="vet-body">
                    ...
                    ?>
                    <a href="https://wa.me/<?php echo e($waPhone); ?>?text=Bonjour%20SMC%20Couture,%20je%20souhaite%20commander%20le%20mod%C3%A8le%20<?php echo e(urlencode($vetement->nom)); ?>%20(Prix%20:%20<?php echo e(number_format($vetement->prix, 0, ',', ' ')); ?>%20CFA)."
                       target="_blank"
                       class="vet-btn-wa">
                        <span>Commander</span>
