    ...
    <div class="container">
        ...
        <div class="dash-hero">
            ...
            <div class="dash-hero-actions">
                <a href="<?php echo e(route('admin.rendezvous.index')); ?>" class="btn-hero-primary">
        ...
        <div class="stats-row">
            <div class="stat-card-new gold">
                ...
                <div class="stat-body">
                    <div class="stat-value"><?php echo e($stats['vetements']); ?></div>
            ...
            <div class="stat-card-new indigo">
                ...
                <div class="stat-body">
                    <div class="stat-value"><?php echo e($stats['clients']); ?></div>
            ...
            <div class="stat-card-new teal">
                ...
                <div class="stat-body">
                    <div class="stat-value"><?php echo e($stats['rendezVous']); ?></div>
            ...
            <div class="stat-card-new amber">
                ...
                <div class="stat-body">
                    <div class="stat-value"><?php echo e($stats['enAttente']); ?></div>
            ...
            <div class="col-lg-6">
                <div class="section-card">
                    <div class="section-card-header">
                        ...
                        <a href="<?php echo e(route('admin.vetements.index')); ?>" class="btn-see-all">
                    ...
                    <div class="section-card-body">
                        ...
                        <div class="vet-row">
                            ...
                            <div class="flex-grow-1 min-width-0">
                                <p class="vet-name"><?php echo e($vetement->nom); ?></p>
                                <p class="vet-price"><?php echo e(number_format($vetement->prix, 0, ',', ' ')); ?> CFA</p>
                            </div>
                            <span class="dispo-pill <?php echo e($vetement->disponible ? 'yes' : 'no'); ?>">
                                <i class="fas fa-<?php echo e($vetement->disponible ? 'check' : 'times'); ?>"></i>
                                <?php echo e($vetement->disponible ? 'Disponible' : 'Indisponible'); ?>
            ...
            <div class="col-lg-6">
                <div class="section-card">
                    <div class="section-card-header">
                        ...
                        <a href="<?php echo e(route('admin.rendezvous.index')); ?>" class="btn-see-all">
                            Voir tout <i class="fas fa-arrow-right fa-xs ms-1"></i>
                        </a>
                    </div>
                    <div class="section-card-body">
                        ...
                        ?>
                        <div class="rdv-row accent-<?php echo e($statutKey); ?>">
                            <div class="rdv-row-avatar"><?php echo e($initials); ?></div>
                            <div class="rdv-row-info">
                                <p class="rdv-row-name"><?php echo e($rdv->client->prenom); ?> <?php echo e($rdv->client->nom); ?></p>
                                <p class="rdv-row-date">
                                    <i class="fas fa-calendar fa-xs"></i>
                                    <?php echo e($rdv->dateRendezVous->format('d/m/Y')); ?> · <?php echo e($rdv->heure); ?>

                                </p>
                            </div>
                            <div class="rdv-row-actions">
                                <span class="status-dot <?php echo e($statutKey); ?>">
                                    <?php if($statutKey === 'confirme'): ?> <i class="fas fa-check-circle"></i> Confirmé
                                    <?php elseif($statutKey === 'refuse'): ?> <i class="fas fa-times-circle"></i> Refusé
                                    <?php else: ?> <i class="fas fa-hourglass-half"></i> Attente
                                    <?php endif; ?>
                                </span>
                                <a href="<?php echo e(route('admin.rendezvous.show', $rdv->id)); ?>" class="btn-eye" title="Voir le détail">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fallou\projet laravel\couture-app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>