<?php $__env->startSection('title', config('app.theme_mode') === 'alternative' ? 'Nos Créations - AURA Couture' : 'Nos Vêtements - Couture App'); ?>
...
<section class="vetements-hero">
    ...
    <div class="container" style="position:relative; z-index:2;">
        <p class="hero-eyebrow">
            <?php if(config('app.theme_mode') === 'alternative'): ?> AURA Couture <?php else: ?> SMC Couture <?php endif; ?>
        </p>
        ...
        <div class="hero-stats">
            <div class="hero-stat">
                <span class="hero-stat-num" id="heroCountTotal"><?php echo e($vetements->count()); ?></span>
...
<section class="collection-section">
    <div class="container">
        ...
        <div class="filter-bar">
            ...
            <div class="filter-pills">
                <a href="<?php echo e(route('vetements.index')); ?>"
                   class="filter-pill <?php echo e(!$categorieId ? 'active' : ''); ?>">
                    <i class="fas fa-th-large" style="font-size:0.7rem;"></i>
                    Tous
                    <span class="pill-count"><?php echo e($vetements->count()); ?></span>
                </a>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $catCount = $vetements->where('categorie_id', $categorie->id)->count(); ?>
                    <a href="<?php echo e(route('vetements.index', ['categorie' => $categorie->id])); ?>"
                       class="filter-pill <?php echo e($categorieId == $categorie->id ? 'active' : ''); ?>">
                        <?php echo e($categorie->nom); ?>

                        <span class="pill-count"><?php echo e($catCount); ?></span>
                    </a>
        ...
        <div class="results-meta" id="resultsMeta">
            ...
            <strong id="visibleCount"><?php echo e($vetements->count()); ?></strong>
            pièce<?php echo e($vetements->count() > 1 ? 's' : ''); ?> trouvée<?php echo e($vetements->count() > 1 ? 's' : ''); ?>
        ...
        <div class="row g-4 view-grid" id="vetementsGrid">
            ...
            <div class="col-md-6 col-lg-4 vetement-item"
                 data-nom="<?php echo e(strtolower($nom)); ?>"
                 data-desc="<?php echo e(strtolower($desc ?? '')); ?>"
                 style="animation-delay: <?php echo e(($loop->index % 6) * 0.08); ?>s">
                ...
                <div class="vet-card">
                    ...
                    <div class="vet-img-wrap">
                        <img
                            ...
                            loading="<?php echo e($loop->index < 6 ? 'eager' : 'lazy'); ?>"
                        >
                    ...
                    <div class="vet-card-body">
                        ...
                        <p class="vet-card-desc"><?php echo e(\Illuminate\Support\Str::limit($desc ?? '', 90)); ?></p>
