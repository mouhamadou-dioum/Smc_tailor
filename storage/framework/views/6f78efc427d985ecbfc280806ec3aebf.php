                ...
                <div class="admin-form">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.vetements.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="taille" id="taille_hidden" value="<?php echo e(old('taille')); ?>" class="taille-input-hidden">
                            <div class="taille-badges">
                                <?php $__currentLoopData = ['XS','S','M','L','XL','XXL','Sur mesure']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="taille-badge <?php echo e(old('taille') === $t ? 'active' : ''); ?>"
                                      onclick="selectTaille(this, '<?php echo e($t); ?>')">
                                    <?php echo e($t); ?>
