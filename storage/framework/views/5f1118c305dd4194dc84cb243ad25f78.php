...
<head>
    ...
    <title>Fiche de Mesures — <?php echo e($client->prenom); ?> <?php echo e($client->nom); ?></title>
    <!-- Google Fonts -->
        ...
        <div class="info-grid">
            <div class="info-section">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><strong><?php echo e($client->prenom); ?> <?php echo e($client->nom); ?></strong></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Téléphone :</span>
                    <span class="info-value"><?php echo e($client->telephone ?? 'Non renseigné'); ?></span>
                </div>
                <div class="info-row">
            ...
            <div class="info-section">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><strong><?php echo e($mesure->nom ?? 'Non renseignée'); ?></strong></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Date Saisie :</span>
                    <span class="info-value"><?php echo e($mesure->created_at->format('d/m/Y H:i')); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Modèle choisi :</span>
                    <span class="info-value"><?php echo e($mesure->modele ?? 'Non spécifié'); ?></span>
                </div>
            </div>
        </div>
        ...
        <table class="measures-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="value-cell"><?php echo e($mesure->cou ?? '—'); ?></td>
                    <td class="unit">cm</td>
                    
                    <td><strong>Bras (Tour de bras)</strong></td>
                    <td class="value-cell"><?php echo e($mesure->tourbras ?? '—'); ?></td>
                    <td class="unit">cm</td>
                </tr>
                <tr>
                    <td><strong>Épaule</strong></td>
                    <td class="value-cell"><?php echo e($mesure->epaule ?? '—'); ?></td>
                    <td class="unit">cm</td>
                    
                    <td><strong>Cuisse</strong></td>
                    <td class="value-cell"><?php echo e($mesure->cuisse ?? '—'); ?></td>
                    <td class="unit">cm</td>
                </tr>
                <tr>
                    <td><strong>Manche</strong></td>
                    <td class="value-cell"><?php echo e($mesure->manche ?? '—'); ?></td>
                    <td class="unit">cm</td>
                    
                    <td><strong>Longueur Chemise</strong></td>
                    <td class="value-cell"><?php echo e($mesure->longueurChemise ?? '—'); ?></td>
                    <td class="unit">cm</td>
                </tr>
                <tr>
                    <td><strong>Hanche</strong></td>
                    <td class="value-cell"><?php echo e($mesure->hanche ?? '—'); ?></td>
                    <td class="unit">cm</td>
                    
                    <td><strong>Longueur Boubou</strong></td>
                    <td class="value-cell"><?php echo e($mesure->longueurBoubou ?? '—'); ?></td>
                    <td class="unit">cm</td>
                </tr>
                <tr>
                    <td><strong>Longueur Pantalon</strong></td>
                    <td class="value-cell"><?php echo e($mesure->longueurPantalon ?? '—'); ?></td>
                    <td class="unit">cm</td>
        ...
        <div class="images-grid">
            <div class="image-card">
                ...
                <?php if($mesure->photo_tissu): ?>
                    <img src="<?php echo e($mesure->photo_tissu); ?>" alt="Tissu">
                <?php else: ?>
            ...
            <div class="image-card">
                ...
                <?php if($mesure->photo_modele): ?>
                    <img src="<?php echo e($mesure->photo_modele); ?>" alt="Modèle">
                <?php else: ?>
                    <div class="image-placeholder">
...
<?php /**PATH C:\Users\fallou\projet laravel\couture-app\resources\views/admin/mesures/print.blade.php ENDPATH**/ ?>