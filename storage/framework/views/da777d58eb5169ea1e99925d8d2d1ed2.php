    ...
    <div class="container">
        ...
        <div class="stats-bar">
            <div class="stat-chip">
                ...
                <div>
                    <div class="stat-chip-value"><?php echo e($clients->count()); ?></div>
            ...
            <div class="stat-chip">
                ...
                <div>
                    <div class="stat-chip-value"><?php echo e($totalRdv); ?></div>
            ...
            <div class="stat-chip">
                ...
                <div>
                    <div class="stat-chip-value"><?php echo e($totalMesures); ?></div>
            ...
            <div class="client-card">
                <div class="client-card-body">
                    ...
                    <div class="client-info">
                        ...
                        <p class="client-meta">
                            ...
                            <?php echo e($client->telephone ?? 'Non renseigné'); ?>

                        </p>
                    </div>
                    <div class="client-actions">
                        <a href="<?php echo e(route('admin.mesures.create', $client->id)); ?>"
                           class="btn-action-sm mesures" title="Prendre les mesures">
                            <i class="fas fa-ruler"></i>
                        </a>
                        <a href="<?php echo e(route('admin.mesures.historique', $client->id)); ?>"
                ...
                <div class="client-card-footer">
                    <span class="rdv-count-pill">
                        ...
                        <?php echo e($client->rendezVous->count()); ?> rendez-vous
                    </span>
                    <span class="inscription-date">
                        <i class="fas fa-clock fa-xs"></i>
                        <?php echo e($client->dateInscription?->format('d/m/Y') ?? '—'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fallou\projet laravel\couture-app\resources\views/admin/clients/index.blade.php ENDPATH**/ ?>