                    ...
                    <form method="POST" action="<?php echo e(route('admin.vetements.update', $vetement->id)); ?>" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="prix" class="form-control form-control-custom" 
                                           value="<?php echo e($vetement->prix); ?>" required min="0" style="border-radius:0 6px 6px 0;">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12">
                                ...
                                <?php $mainImage = $vetement->images->where('ordre', 0)->first(); ?>
                                <?php if($mainImage): ?>
                                    <div class="current-img-label">Actuelle :</div>
                                    <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($mainImage->image_url)); ?>" class="current-image mb-2"
                            ...
                            <div class="col-md-4">
                                ...
                                <?php $detailImage = $vetement->images->where('ordre', $i)->first(); ?>
                                <?php if($detailImage): ?>
                                    <div class="current-img-label">Actuelle :</div>
                                    <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($detailImage->image_url)); ?>" class="current-image mb-2"
                                         onerror="this.style.display='none'">
                                <?php endif; ?>
                                <div class="upload-zone" id="zone-detail-<?php echo e($i); ?>">
                                    ...
                                    <p style="font-size:0.8rem;"><?php echo e($detailImage ? 'Changer' : 'Ajouter'); ?> la photo détail <?php echo e($i); ?></p>
