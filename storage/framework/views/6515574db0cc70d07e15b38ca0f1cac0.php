        ...
        <div class="email-content">
            ...
            <div class="email-body">
                ...
                <div class="btn-container">
                    <a href="<?php echo e($resetLink); ?>" class="btn-primary" target="_blank">Réinitialiser le mot de passe</a>
                </div>
                ...
                <div class="link-break">
                    ...
                    <a href="<?php echo e($resetLink); ?>" style="color: #c9a959;"><?php echo e($resetLink); ?></a>
                </div>
            </div>
            
            <!-- Footer -->
            <div class="email-footer">
                &copy; <?php echo e(date('Y')); ?> SMC Couture. Tous droits réservés.<br>
                Dakar, Sénégal.
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\fallou\projet laravel\couture-app\resources\views/emails/forgot-password.blade.php ENDPATH**/ ?>