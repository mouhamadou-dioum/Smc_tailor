...
<section class="py-5" style="background: linear-gradient(135deg, var(--dark) 0%, #2d2d4a 100%); min-height:80vh;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="text-center mb-4">
                    <h2 class="section-title" style="color:#fff;">Connexion Admin</h2>
                    <p class="section-subtitle" style="color:rgba(255,255,255,0.7);">Espace Administration</p>
                </div>
                <div class="form-custom">
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo e(route('home')); ?>" style="color:rgba(255,255,255,0.7);">
