                ...
                <div class="form-custom">
                    ...
                    <form method="POST" action="{{ route('admin.vetements.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nom" class="form-control form-control-custom" required value="{{ old('nom') }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label-custom">Description</label>
                            <textarea name="description" class="form-control form-control-custom" rows="4">{{ old('description') }}</textarea>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label-custom">Prix (CFA) *</label>
                                <input type="number" name="prix" class="form-control form-control-custom" required min="0" value="{{ old('prix') }}">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" name="imageUrl" class="form-control form-control-custom" 
                                   placeholder="https://..." value="{{ old('imageUrl') }}">
                        </div>
