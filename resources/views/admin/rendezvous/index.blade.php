                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="dropdownMenuButton{{ $rdv->id }}" style="border-radius: 12px; border: 1px solid var(--gray-200); font-size: 0.85rem; padding: 0.5rem 0; min-width: 180px;">
                        ...
                        @if($rdv->statut === \App\Models\RendezVous::STATUT_EN_ATTENTE)
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-2 py-2 text-success fw-bold btn-ajax-action" href="{{ route('admin.rendezvous.confirmer', $rdv->id) }}" data-confirm-msg="Confirmer ce RDV ?">
                                    <i class="fas fa-check" style="width: 16px;"></i> Confirmer
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-2 py-2 text-danger fw-bold btn-ajax-action" href="{{ route('admin.rendezvous.refuser', $rdv->id) }}" data-confirm-msg="Refuser ce RDV ?">
