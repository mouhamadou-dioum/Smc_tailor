    ...
    <nav class="navbar-custom">
        <div class="container">
            <div class="navbar-inner">
                ...
                <a class="navbar-brand" href="{{ route('home') }}">SMC<span style="color:rgba(201,169,89,0.5); margin:0 0.2rem;">—</span>COUTURE</a>
                ...
                <div class="nav-actions" id="navMenu">
                    ...
                    @elseif($isClient)
                        ...
                        <a href="{{ route('rendezvous.index') }}" class="nav-link-custom">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="btn btn-primary-custom btn-sm ms-2">
    ...
    <footer class="site-footer">
        ...
        <div class="footer-cta">
            <div class="footer-cta-inner">
                ...
                <a href="{{ route('register') }}" class="footer-cta-btn">
            ...
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        ...
                        @auth('client')
                        <li><a href="{{ route('rendezvous.index') }}" class="footer-nav-link"><i class="fas fa-chevron-right"></i>Mes rendez-vous</a></li>
                        @endauth
                        @guest('client')
                        <li><a href="{{ route('login') }}" class="footer-nav-link"><i class="fas fa-chevron-right"></i>Connexion</a></li>
                        <li><a href="{{ route('register') }}" class="footer-nav-link"><i class="fas fa-chevron-right"></i>S'inscrire</a></li>
                        @endguest
                    </ul>
                </div>
